  ...
  <DashboardLayout>
    <div class="space-y-4 page-enter">
      <PageHeader title="Profil">
        <button
          class="rounded-lg bg-[#F5F5F5] px-5 py-2 text-sm font-semibold text-[#A2A2A2] shadow-sm transition-all duration-200 hover:bg-primary/90 hover:shadow-md active:scale-95 disabled:opacity-70"
      ...
      <div class="grid gap-4 lg:grid-cols-[2fr_1fr] items-start">
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <button
              class="mb-2 flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-primary text-sm font-semibold text-black shadow-sm transition-all duration-200 hover:bg-primary/90 hover:shadow-md active:scale-95"
            >
              <svg
            ...
            <button
              class="flex h-11 w-full items-center justify-center gap-2 rounded-lg text-sm font-medium text-destructive transition-all duration-150 hover:bg-red-50 active:scale-95"
